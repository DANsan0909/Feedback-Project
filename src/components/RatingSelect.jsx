...
const RatingSelect =({select})=> {
    ...
    const { feedbackEditNow} = useContext(FeedbackContext)
    useEffect(()=>{
        setSelected(feedbackEditNow.item.rating)
    },[feedbackEditNow])
    ...
    return (
        <ul className='rating'>
            <li>
                <input type="radio" id='num0' name='rating' value='0' onChange={handleChange} checked={selected === 0} />
                <label htmlFor="num0">0</label>
            </li>
            <li>
